  ...
  return (
    ...
    {/* ---------------------left side------------------- */}
     ...
     <div className="flex flex-col gap-4 w-full sm:max-w-[480px]">
         ...
         <input type="email" className="border border-gray-300 rounded py-1.5 px-3.5 w-full" placeholder="E-mail adress" />
         ...
         <div className="flex gap-3">
          <input type="number" className="border border-gray-300 rounded py-1.5 px-3.5 w-full" placeholder="Pin-code" />
